...
import { MapPin, Phone, Mail, Clock, MessageCircle, Send, CheckCircle2, Image as ImageIcon } from "lucide-react";
...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const text = `*New Admission Inquiry - Afsar Academy*\n\n` +
      `*Name:* ${formData.name}\n` +
    ...
    <div className="space-y-16 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          {/* Left Info & Google Maps Embed (6 Cols) */}
          <div className="lg:col-span-6 space-y-8">
            <RevealOnScroll direction="left" className="space-y-6">
              ...
              {/* Campus Landmark Building Photo Placeholder */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex items-center gap-3 p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
                    ...
                    <div>
                      ...
                      <a href={`tel:${siteConfig.phone.replace(/\s+/g, "")}`} className="text-xs text-slate-600 hover:text-orange">
                        {siteConfig.phone}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${siteConfig.email}`} className="text-xs text-slate-600 hover:text-orange">
                        {siteConfig.email}
                      </a>
                    </div>
                  </div>
          ...
          {/* Right Dark Navy Contact Form (6 Cols) */}
